...
1. The Surface (Interface) The Surface is your optical interface and the "mission control for parallel agent tasks".
...
2. The Engine (Harness) The Engine is the execution loop connecting the brain to the tools.
...
3. The Soil (Context) The Soil is the structured memory and local data analytics layer.
